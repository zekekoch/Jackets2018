...
void setup()
{
  ...
  Serial.begin(57600);
  Serial.println(F("https://github.com/zekekoch/Jackets2018"));
...
void showLeds()
{
  ...
  for(byte tube = 0; tube < numTubes; tube++) 
  {
    ...
    {      
      // for the leds going forward just copy them to the strip
    ...
    { 
      // for the leds going backwards start at the end and work backwards     
      // i should probably just replace them in place, but this is conceptually simpler for me now
      for(int iLed = 0; iLed < tubeLengths[tube]; iLed++) 
      {
